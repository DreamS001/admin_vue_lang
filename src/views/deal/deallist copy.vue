  ...
  <div class="wscn-http404-container">
    <div class="nav-a">
      <div class="block" style="margin-left:30px;">
        ...
        <span class="demonstration" style="margin-right:25px">流水号：</span>
        <input
          style="width:200px;height:28px;border:2px solid #2fe4ff"
          type="text"
          v-model="name"
        />
    ...
    <div style="width:100%!important;margin-top:20px">
      ...
      <el-table :data="list" style="width: 100%" :row-class-name="setClassName" :header-cell-class-name="handlemyclass" highlight-current-row >
        <el-table-column prop="merchant_order_id" label="流水号" align="center"></el-table-column>
				<el-table-column prop="merchant_order_id" label="名称" align="center"/>
        <el-table-column prop="qcf_device_num" label="设备号" align="center" :show-overflow-tooltip="true"></el-table-column>
        <el-table-column prop="complete_time" label="交易时间" align="center" :show-overflow-tooltip="true"></el-table-column>
        <el-table-column prop="order_amount" label="交易金额（$）" align="center" :show-overflow-tooltip="true"></el-table-column>
        <el-table-column prop="order_status" label="交易状态" align="center" :show-overflow-tooltip="true">
					<template slot-scope="scope">
            <div class="status-box" style="background:rgba(255, 73, 73, 1);" v-if="scope.row.order_status===0">未提交</div>
            <div class="status-box" style="background:rgba(19, 206, 102, 1);" v-else-if="scope.row.order_status===3">交易成功</div>
            <div class="status-box" style="background:rgba(47, 228, 255, 1);" v-else-if="scope.row.order_status===5">退款完成</div>
            <div class="status-box" style="background:rgba(19, 206, 102, 1);" v-else-if="scope.row.order_status===7">订单已撤销</div>
            <div class="status-box" style="background:rgba(255, 73, 73, 1);" v-else>未知状态</div>
          </template>
				</el-table-column>
        <el-table-column prop="loc_info" label="备注" align="center" :show-overflow-tooltip="true"></el-table-column>
      </el-table>



      <el-table :header-row-class-name="handlemyclass"  :data="list" highlight-current-row style="width: 100%;" :row-class-name="setClassName">
        <el-table-column prop="merchant_order_id" label="流水号" align="center"></el-table-column>
				<el-table-column prop="merchant_order_id" label="名称" align="center"/>
        <el-table-column prop="qcf_device_num" label="设备号" align="center" :show-overflow-tooltip="true"></el-table-column>
        <el-table-column prop="complete_time" label="交易时间" align="center" :show-overflow-tooltip="true"></el-table-column>
