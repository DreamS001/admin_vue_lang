    ...
    <el-row :gutter="15">
      ...
      <el-col :xs="24" :sm="24" :md="16" :lg="16" :xl="17">
        <el-card class="box-card" shadow="never">
          <div slot="header" class="clearfix">
            <span class="role-span" style="color: #fff;">角色列表</span>
          ...
          <el-table :header-row-class-name="handlemyclass"  :data="data" highlight-current-row style="width: 100%;" @current-change="handleCurrentChange" :row-class-name="setClassName">
      ...
      <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="7">
        <el-card v-show="opt === '菜单分配'" class="box-card" shadow="never">
          <div slot="header" class="clearfix">
            <el-tooltip class="item" effect="dark" content="选择指定角色分配菜单" placement="top">
              <span class="role-span" style="color:#fff;">菜单分配</span>
            </el-tooltip>
            <el-button
        ...
        <el-card v-show="opt === '权限分配'" class="box-card" shadow="never">
          ...
          <el-tree style="background:rgba(24, 136, 203, 0.4);"
            ref="permission"
            :data="permissions"
...
<style rel="stylesheet/scss" lang="scss">
  ...
  .el-card__header{
    border: 1px solid rgba(32, 163, 245, 0.4) !important;
  }
  .el-card{
