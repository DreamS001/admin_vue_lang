            ...
            <el-table v-loading="loading" :data="data" size="small" style="width: 100%;">
              ...
              <el-table-column prop="time" label="请求耗时" align="center">
                <template slot-scope="scope">
                  <el-tag v-if="scope.row.time <= 300">{{ scope.row.beginDate }}ms</el-tag>
                  <el-tag v-else-if="scope.row.time <= 1000" type="warning">{{ scope.row.beginDate }}ms</el-tag>
                  <el-tag v-else type="danger">{{ scope.row.beginDate }}ms</el-tag>
                </template>
              </el-table-column>
